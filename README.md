...
## События
### Узнать подробности про аниме

Примеры

| Действие                        | Вопрос                                             | Ответ |
| -------------                   |:------------------:                                | -----:|
| Узнать студию производителя     | Кто занимался производством сериала  `title_name`  | Аниме `title_name` выпущено студией `studio_name` |
| Узнать студию производителя     | Кто занимался производством сериала  `title_name`  | Аниме `title_name` выпущено студией `studio_name` |
|                                 | Кто занимался производством сериала  `title_name` |        |
|                                 | Какая студия выпустила `studio_name`              |        |
...
- Рекомендация по жанрам и тайтлам 
- Рекомендация по моим предпочтениям
- Рекомендация похожего
- Узнать возрастной рейтинг 
- Узнать год выпуска
- Узнать длительность серии
- Узнать жанры
- Узнать описание
- Узнать оценку:
  - пример запроса:
